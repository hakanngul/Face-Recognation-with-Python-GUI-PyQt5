...
class Ui_OgrenciEkleWindow(object):
    def setupUi(self, OgrenciEkleWindow):
        ...
        OgrenciEkleWindow.resize(542, 873)
...
"}")
        ...
        self.cmb_Program.addItem("")
        self.gridLayout_2.addWidget(self.cmb_Program, 7, 2, 1, 1)
        ...
        self.cmb_Sinif.addItem("")
        self.cmb_Sinif.addItem("")
        self.gridLayout_2.addWidget(self.cmb_Sinif, 8, 2, 1, 1)
        self.btn_kayit = QtWidgets.QPushButton(self.groupBox)
        self.btn_kayit.setObjectName("btn_kayit")
        self.gridLayout_2.addWidget(self.btn_kayit, 11, 0, 1, 3)
        ...
        self.cmb_Sube.addItem("")
        self.cmb_Sube.addItem("")
        self.gridLayout_2.addWidget(self.cmb_Sube, 6, 2, 1, 1)
        ...
        self.cmb_Bolum.addItem("")
        self.cmb_Bolum.addItem("")
        self.gridLayout_2.addWidget(self.cmb_Bolum, 5, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.txt_Okulno, 1, 2, 1, 1)
    ...
    def retranslateUi(self, OgrenciEkleWindow):
        ...
        self.btn_resimCek.setText(_translate("OgrenciEkleWindow", "Resim Çek"))
